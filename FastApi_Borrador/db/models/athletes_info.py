...
class Athletes(Base):
    ...
    phones           =      relationship('Phones', backref='athletes')
...
class Fitness_Centers(Base):
    ...
    phones           = relationship('Phones', backref='fitness_center')
...
class Phones(Base): 
    ...
    country_code          = Column(String(4), ForeignKey('country_codes.code'))
