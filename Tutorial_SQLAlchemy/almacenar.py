...
from models.album import Album, Medio
from models.declarative_base import Session, engine, Base
...
if __name__ == '__main__':
   ...
   # Crear álbumes
   album1 = Album(titulo = "Latin Jazz Compilation", ano = 2021, descripcion = "Album original", medio = Medio.CASETE)
